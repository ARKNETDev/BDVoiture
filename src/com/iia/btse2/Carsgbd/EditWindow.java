...
public class EditWindow extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnEdit){	
			...
			VoitureDAO cDao = new VoitureDAO();
			insertcar.setMarque(EditWindow.this.txt_Marque.getText());
			insertcar.setModele(EditWindow.this.txt_Modele.getText());
			insertcar.setCouleur(EditWindow.this.txt_Couleur.getText());
			insertcar.setAnnee(Integer.parseInt(EditWindow.this.txt_Annee.getText()));
			insertcar.setVitesse(Integer.parseInt(EditWindow.this.txt_Vitesse.getText()));
			insertcar.setPrix(Integer.parseInt(EditWindow.this.txt_Prix.getText()));
			cDao.update(insertcar);
